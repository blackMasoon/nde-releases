...
pdf_options:
  ...
  margin:
    ...
    left: "20mm"
    right: "20mm"
generated_at: "2026-02-14T12:54:59.361Z"
---
...
Cada característica tiene un dado: <span class="rpg-token token-d4">k4</span>, <span class="rpg-token token-d6">k6</span>, <span class="rpg-token token-d8">k8</span>, <span class="rpg-token token-d12">k12</span> o <span class="rpg-token token-d20">k20</span>.  Cuando usas una característica, lanzas **un dado** de esa característica.

- Dado más grande = mayor probabilidad de éxito y de éxito excepcional (máx en el dado).

**Ejemplo:** Tienes Destreza <span class="rpg-token token-d8">k8</span>. Cuando disparas, escalas o te deslizas, normalmente lanzas <span class="rpg-token token-d8">k8</span>.
