...
pdf_options:
  ...
  margin:
    ...
    left: "20mm"
    right: "20mm"
generated_at: "2026-02-14T12:54:59.507Z"
---
...
Każda cecha ma kość: <span class="rpg-token token-d4">k4</span>, <span class="rpg-token token-d6">k6</span>, <span class="rpg-token token-d8">k8</span>, <span class="rpg-token token-d12">k12</span> lub <span class="rpg-token token-d20">k20</span>.  
...
**Przykład:** Masz Zręczność <span class="rpg-token token-d8">k8</span>. Gdy strzelasz, wspinasz się albo skradasz, zwykle rzucasz <span class="rpg-token token-d8">k8</span>.
