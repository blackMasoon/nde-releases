...
pdf_options:
  ...
  margin:
    ...
    left: "20mm"
    right: "20mm"
generated_at: "2026-01-13T12:23:01.353Z"
---
...
- **Movimento:** até 5 quadrados (Alcance 5) ou 1 zona.
- **Corrida:** se não atacar, pode mover-se 2x mais longe (10 quadrados / 2 zonas).
...
- **Ordem:** jogadores → inimigos → repetir.
- **Ataque:** corpo a corpo = S, distância = M (Z); <span class="rpg-token token-tn">TN</span> do inimigo: lacaio 6, elite 8, chefe 12.
- **Acerto:** lacaio morre; elite/chefe recebe 1 Ferimento (chefe tem 3). Sucesso excepcional = geralmente 2 Ferimentos.
- **Erro:** se o inimigo podia alcançar você → perde 1 Coração (retaliação). Em cobertura/longe — normalmente sem retaliação.

Escalar a pressão:
- Muitos lacaios "corpo a corpo" → <span class="rpg-token token-tn">TN</span> +1 ou complicação extra ao errar.
- Mude o terreno a cada turno: surgem obstáculos, gargalos, oportunidades de vantagem.
