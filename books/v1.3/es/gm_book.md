...
pdf_options:
  ...
  margin:
    ...
    left: "20mm"
    right: "20mm"
generated_at: "2026-01-13T12:23:01.384Z"
---
...
- **Orden:** jugadores → enemigos → repetir.
- **Ataque:** cuerpo a cuerpo = F (S), distancia = D (Z); <span class="rpg-token token-tn">TN</span> del enemigo: esbirro 6, élite 8, jefe 12.
- **Impacto:** esbirro muere; élite/jefe recibe 1 Herida (jefe tiene 3). Éxito excepcional = normalmente 2 Heridas.
- **Fallo:** si el enemigo podía alcanzarte → pierdes 1 Corazón (venganza). En cobertura/lejos — normalmente sin venganza.

Escalar la presión:
- Muchos esbirros "en contacto" → <span class="rpg-token token-tn">TN</span> +1 o complicación extra al fallar.
- Cambia el terreno cada turno: aparecen obstáculos, cuellos de botella, oportunidades de ventaja.
