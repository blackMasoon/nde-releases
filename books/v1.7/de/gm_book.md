...
pdf_options:
  ...
  margin:
    ...
    left: "20mm"
    right: "20mm"
generated_at: "2026-02-14T11:04:15.304Z"
---
...
<span class="rpg-token token-d4">k4</span>→<span class="rpg-token token-d6">k6</span>→<span class="rpg-token token-d8">k8</span>→<span class="rpg-token token-d12">k12</span>→<span class="rpg-token token-d20">k20</span>
...
### 7.1. Komplikationen beim Scheitern (würfle <span class="rpg-token token-d6">k6</span>)
