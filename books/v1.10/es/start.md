...
pdf_options:
  ...
  margin:
    ...
    left: "20mm"
    right: "20mm"
generated_at: "2026-01-14T12:08:48.769Z"
---
...
### [ERROR] 6) Rozwój postaci (kampania bez tabel i księgowości)

[Translation Failed] Po przygodzie wybierz **jedno**:
...
* **Iskra:** raz na scenę możesz wydać 1 PM, by automatycznie uzyskać „sukces z kosztem” bez rzutu.

**Przykład:** Adept podbija M z <span class="rpg-token token-d8">k8</span> na <span class="rpg-token token-d12">k12</span> – teraz jego moce wchodzą stabilniej przy T 5–6.



---

### [ERROR] 7) Wariant „tylko <span class="rpg-token token-d6">k6</span>” w trybie **2k6** (szybki i bardzo grywalny)

[Translation Failed] Jeżeli nie macie zestawu kości albo chcecie bardziej „fabularne” stopnie wyniku:
...
**Przykład:** Specjalista strzela w biegu: Z = +2, sytuacja trudna (-1). Rzut 2k6 = 8, suma 9: sukces z kosztem – trafia, ale kończy w odsłoniętej pozycji.
