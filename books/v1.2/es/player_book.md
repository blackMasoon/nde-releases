...
pdf_options:
  ...
  margin:
    ...
    left: "20mm"
    right: "20mm"
generated_at: "2026-01-13T06:26:48.850Z"
---
...
- Golpeas a un cono → sale de la pelea.
...
### 6.4 Pudło y "venganza"
Si **fallas** (resultado < <span class="rpg-token token-tn">TN</span>) y el oponente podría alcanzarte realmente, pierdes **1 Corazón**.
- En el cuerpo a cuerpo esto es común.
- En los ataques a distancia, mucho depende de la cobertura y la situación.

Tu lección táctica: **colócate de manera que al fallar no recibas venganza** (cobertura, distancia, plan, ayuda).
